...
public class VueCrediterCompte extends javax.swing.JFrame {
     ...
     */
    public VueCrediterCompte() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Crediter Compte");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Créditer votre compte");

        jLabel2.setText("Combien de minutes voulez-vous rajouter ?");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ema/nemovelo/temps.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueCrediterCompte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
